...
namespace MAD.DataWarehouse.BIM360.Database.Migrations
{
    ...
    [Migration("20220907001328_AddTable_FolderItem")]
    partial class AddTable_FolderItem
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MAD.DataWarehouse.BIM360.Api.Project.FolderItem", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("MAD.DataWarehouse.BIM360.Api.Project.FolderItem", b =>
                {
                    b.OwnsOne("MAD.DataWarehouse.BIM360.Api.Project.FolderItemAttribute", "Attributes", b1 =>
                        {
                            ...
                            b1.OwnsOne("MAD.DataWarehouse.BIM360.Api.Project.FolderItemAttributeExtension", "Extension", b2 =>
                                {
                                    ...
                                    b2.OwnsOne("MAD.DataWarehouse.BIM360.Api.Project.FolderItemAttributeExtensionData", "Data", b3 =>
                                        {
                    ...
                    b.OwnsOne("MAD.DataWarehouse.BIM360.Api.Project.FolderItemRelationships", "Relationships", b1 =>
                        {
                            b1.Property<string>("FolderItemId")
                                .HasColumnType("nvarchar(450)");
                            ...
                            b1.OwnsOne("MAD.DataWarehouse.BIM360.Api.Project.FolderItemParent", "Parent", b2 =>
                                {
                                    ...
                                    b2.OwnsOne("MAD.DataWarehouse.BIM360.Api.Project.FolderItemParentData", "Data", b3 =>
                                        {
                                            b3.Property<string>("FolderItemParentFolderItemRelationshipsFolderItemId")
                                                .HasColumnType("nvarchar(450)");

                                            b3.Property<string>("FolderItemParentFolderItemRelationshipsFolderItemProjectId")
                                                .HasColumnType("nvarchar(450)");
                                            ...
                                            b3.HasKey("FolderItemParentFolderItemRelationshipsFolderItemId", "FolderItemParentFolderItemRelationshipsFolderItemProjectId");
                                            ...
                                            b3.WithOwner()
                                                .HasForeignKey("FolderItemParentFolderItemRelationshipsFolderItemId", "FolderItemParentFolderItemRelationshipsFolderItemProjectId");
                                        });
